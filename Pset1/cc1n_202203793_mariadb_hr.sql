CREATE DATABASE uvv;
CREATE USER carlos IDENTIFIED BY 'computacao@raiz';
GRANT ALL PRIVILEGES ON uvv.* TO carlos;
FLUSH PRIVILEGES;
...
INSERT INTO paises (id_pais, nome_, id_regiao) VALUES
('AR', 'Argentina', 2);
INSERT INTO paises (id_pais, nome_, id_regiao) VALUES
('AU', 'Australia', 3);
INSERT INTO paises (id_pais, nome_, id_regiao) VALUES
...
INSERT INTO localizacoes (id_localizacao, endereço, cep, cidade, uf, id_pais) VALUES
...
INSERT INTO departamentos (id_departamento, nome, id_localizacao, id_supervisor) VALUES
...
INSERT INTO cargos (id_cargos, cargos, salario_minimo, salario_maximo) VALUES
...
INSERT INTO historico_cargos (id_departamento,id_cargos,id_empregado, data_final, data_inicial) VALUES
...
/*A baixo seguem os comandos relativos a criação das foreing keys das tabelas e os relacionamnetos entre elas.
  (obs: Note que teremos a criação de foreign keys e ao mesmo tempo*/



ALTER TABLE paises ADD CONSTRAINT regioes_paises_fk -- comando que estabelece a foreign key da tabela paises, relacionando-a á tabela regiões.
FOREIGN KEY (id_regiao)
REFERENCES regioes (id_regiao)
;

ALTER TABLE localizacoes ADD CONSTRAINT paises_localizacoes_fk -- comando que estabelece a foreign key da tabela localizações, relacionando-a á tabela paises.
FOREIGN KEY (id_pais)
REFERENCES paises (id_pais)
;

ALTER TABLE departamentos ADD CONSTRAINT localizacoes_departamentos_fk -- comando que estabelece a foreign key da tabela departamentis, relacionando-a á tabela localizações.
FOREIGN KEY (id_localizacao)
REFERENCES localizacoes (id_localizacao)
;

ALTER TABLE historico_cargos ADD CONSTRAINT departamentos_historico_cargos_fk -- comando que estabelece a foreign key da tabela historico_cargos, relacionando-a á tabela departamentos (parte da composite key).
FOREIGN KEY (id_departamento)
REFERENCES departamentos (id_departamento)
;


ALTER TABLE historico_cargos ADD CONSTRAINT empregados_historico_cargos_fk -- comando que estabelece a foreign key da tabela historico_cargos, relacionando-a á tabela empregados (parte da composite key).
FOREIGN KEY (id_empregado)
REFERENCES empregados (id_empregado)
;


ALTER TABLE empregados ADD CONSTRAINT empregados_empregados_fk -- comando que estabelece a foreign key da tabela empregados, relacionando-a á tabela empregados (note que será criado um auto_relacionamento.).
...
ALTER TABLE empregados ADD CONSTRAINT cargos_empregados_fk -- comando que estabelece a foreign key da tabela empregados, relacionando-a á tabela cargos.
FOREIGN KEY (id_cargos)
REFERENCES cargos (id_cargos)
;